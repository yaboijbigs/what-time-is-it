...
export interface Node<Props> {
    ...
    trigger<K extends FunctionKeys<Props>>(prop: K, ...args: DeepPartial<MaybeFunctionParameters<Props[K]>>): MaybeFunctionReturnType<NonNullable<Props[K]>>;
...
type DeepPartial<T> = T extends (infer U)[] ? DeepPartial<U>[] : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartial<U>> : T extends object ? {

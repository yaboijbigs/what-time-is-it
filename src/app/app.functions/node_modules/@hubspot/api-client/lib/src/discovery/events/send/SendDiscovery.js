...
const rxjsStub_1 = require("../../../../codegen/events/send/rxjsStub");
...
class EventsDiscovery {
    constructor(config) {
        ...
        this.customEventDataApi = ApiDecoratorService_1.default.getInstance().apply(new index_1.CustomEventDataApi(configuration));
    }
}
exports.default = EventsDiscovery;
//# sourceMappingURL=SendDiscovery.js.map
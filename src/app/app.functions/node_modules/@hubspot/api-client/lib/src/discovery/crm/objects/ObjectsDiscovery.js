...
class ObjectsDiscovery extends BaseDiscovery_1.default {
    ...
    get communications() {
        if (!this._communications) {
            ...
            this._communications = new requiredClass.default(this.config);
        }
    ...
    get goals() {
        if (!this._goals) {
            ...
            this._goals = new requiredClass.default(this.config);
        }
        return this._goals;
    }
    get leads() {
        if (!this._leads) {
            ...
            this._leads = new requiredClass.default(this.config);
        }
        return this._leads;
    }
    get meetings() {
    ...
    get taxes() {
        if (!this._taxes) {
            ...
            this._taxes = new requiredClass.default(this.config);
        }
        return this._taxes;
    }
}

...
exports.MergeApiResponseProcessor = exports.MergeApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class MergeApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    merge(publicMergeInput, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (publicMergeInput === null || publicMergeInput === undefined) {
                throw new baseapi_1.RequiredError("MergeApi", "merge", "publicMergeInput");
            }
...
exports.MergeApiRequestFactory = MergeApiRequestFactory;
class MergeApiResponseProcessor {
...
exports.MergeApiResponseProcessor = MergeApiResponseProcessor;
//# sourceMappingURL=MergeApi.js.map
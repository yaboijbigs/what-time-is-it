...
class PromiseBasicApi {
    ...
    archiveWithHttpInfo(postalMailId, _options) {
        const result = this.api.archiveWithHttpInfo(postalMailId, _options);
        return result.toPromise();
    }
    archive(postalMailId, _options) {
        const result = this.api.archive(postalMailId, _options);
        return result.toPromise();
    }
    ...
    getByIdWithHttpInfo(postalMailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getByIdWithHttpInfo(postalMailId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    getById(postalMailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getById(postalMailId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    updateWithHttpInfo(postalMailId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.updateWithHttpInfo(postalMailId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }
    update(postalMailId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.update(postalMailId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }
}

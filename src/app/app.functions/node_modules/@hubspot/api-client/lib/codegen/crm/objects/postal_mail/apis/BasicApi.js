...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(postalMailId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (postalMailId === null || postalMailId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "postalMailId");
            }
    ...
    getById(postalMailId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMailId === null || postalMailId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "postalMailId");
            }
            const localVarPath = '/crm/v3/objects/postal_mail/{postalMailId}'
                .replace('{' + 'postalMailId' + '}', encodeURIComponent(String(postalMailId)));
    ...
    update(postalMailId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (postalMailId === null || postalMailId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "postalMailId");
            }

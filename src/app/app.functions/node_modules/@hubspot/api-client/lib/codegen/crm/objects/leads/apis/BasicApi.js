...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(leadsId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (leadsId === null || leadsId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "leadsId");
            }
            const localVarPath = '/crm/v3/objects/leads/{leadsId}'
                .replace('{' + 'leadsId' + '}', encodeURIComponent(String(leadsId)));
    ...
    create(simplePublicObjectInputForCreate, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/leads';
    ...
    getById(leadsId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (leadsId === null || leadsId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getById", "leadsId");
            }
            const localVarPath = '/crm/v3/objects/leads/{leadsId}'
                .replace('{' + 'leadsId' + '}', encodeURIComponent(String(leadsId)));
    ...
    update(leadsId, simplePublicObjectInput, idProperty, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (leadsId === null || leadsId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "update", "leadsId");
            }

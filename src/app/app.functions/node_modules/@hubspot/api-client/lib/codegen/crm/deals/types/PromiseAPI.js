...
class PromiseBasicApi {
    ...
    archiveWithHttpInfo(dealId, _options) {
        const result = this.api.archiveWithHttpInfo(dealId, _options);
    ...
    getByIdWithHttpInfo(dealId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getByIdWithHttpInfo(dealId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    updateWithHttpInfo(dealId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.updateWithHttpInfo(dealId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }

...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(meetingId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(meetingId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(meetingId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;

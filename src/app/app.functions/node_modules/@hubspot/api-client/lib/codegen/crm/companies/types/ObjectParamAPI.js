...
exports.ObjectSearchApi = exports.ObjectMergeApi = exports.ObjectBatchApi = exports.ObjectBasicApi = void 0;
...
class ObjectBasicApi {
    ...
    archiveWithHttpInfo(param, options) {
        return this.api.archiveWithHttpInfo(param.companyId, options).toPromise();
    }
    ...
    getByIdWithHttpInfo(param, options) {
        return this.api.getByIdWithHttpInfo(param.companyId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    ...
    updateWithHttpInfo(param, options) {
        return this.api.updateWithHttpInfo(param.companyId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
...
exports.ObjectMergeApi = ObjectMergeApi;

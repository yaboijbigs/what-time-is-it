...
exports.MembershipsApiResponseProcessor = exports.MembershipsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class MembershipsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    add(listId, requestBody, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "add", "listId");
            }
            if (requestBody === null || requestBody === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "add", "requestBody");
            }
    ...
    addAllFromList(listId, sourceListId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "addAllFromList", "listId");
            }
            if (sourceListId === null || sourceListId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "addAllFromList", "sourceListId");
            }
    ...
    addAndRemove(listId, membershipChangeRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "addAndRemove", "listId");
            }
            if (membershipChangeRequest === null || membershipChangeRequest === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "addAndRemove", "membershipChangeRequest");
            }
    ...
    getLists(objectTypeId, recordId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectTypeId === null || objectTypeId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "getLists", "objectTypeId");
            }
            if (recordId === null || recordId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "getLists", "recordId");
            }
    ...
    getPage(listId, after, before, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "getPage", "listId");
            }
    ...
    getPageOrderedByAddedToListDate(listId, after, before, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "getPageOrderedByAddedToListDate", "listId");
            }
    ...
    remove(listId, requestBody, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "remove", "listId");
            }
            if (requestBody === null || requestBody === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "remove", "requestBody");
            }
    ...
    removeAll(listId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("MembershipsApi", "removeAll", "listId");
            }
            const localVarPath = '/crm/v3/lists/{listId}/memberships'
                .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
...
exports.MembershipsApiRequestFactory = MembershipsApiRequestFactory;
class MembershipsApiResponseProcessor {
    addWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "MembershipsUpdateResponse", "");
    ...
    addAllFromListWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    addAndRemoveWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "MembershipsUpdateResponse", "");
    ...
    getListsWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ApiCollectionResponseRecordListMembershipNoPaging", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    getPageWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ApiCollectionResponseJoinTimeAndRecordId", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    getPageOrderedByAddedToListDateWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ApiCollectionResponseJoinTimeAndRecordId", "");
    ...
    removeAllWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("204", response.httpStatusCode)) {
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
...
exports.MembershipsApiResponseProcessor = MembershipsApiResponseProcessor;
//# sourceMappingURL=MembershipsApi.js.map
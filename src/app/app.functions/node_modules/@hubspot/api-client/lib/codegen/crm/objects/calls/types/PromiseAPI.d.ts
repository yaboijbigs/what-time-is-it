...
export declare class PromiseBasicApi {
    ...
    archiveWithHttpInfo(callId: string, _options?: Configuration): Promise<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(callId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(callId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;

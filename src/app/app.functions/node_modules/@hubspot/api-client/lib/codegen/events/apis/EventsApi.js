    ...
    getPage(objectType, eventType, after, before, limit, sort, occurredAfter, occurredBefore, objectId, objectPropertyPropname, propertyPropname, id, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectPropertyPropname !== undefined) {
                requestContext.setQueryParam("objectProperty.{propname}", ObjectSerializer_1.ObjectSerializer.serialize(objectPropertyPropname, "any", ""));
            }
            if (propertyPropname !== undefined) {
                requestContext.setQueryParam("property.{propname}", ObjectSerializer_1.ObjectSerializer.serialize(propertyPropname, "any", ""));
            }
            if (id !== undefined) {
                requestContext.setQueryParam("id", ObjectSerializer_1.ObjectSerializer.serialize(id, "Array<string>", ""));
            }
            let authMethod;

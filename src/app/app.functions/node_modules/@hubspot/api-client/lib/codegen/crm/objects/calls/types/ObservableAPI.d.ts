...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(callId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(callId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(callId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;

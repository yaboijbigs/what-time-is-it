...
export declare class ObjectGDPRApi {
    ...
    purgeWithHttpInfo(param: GDPRApiPurgeRequest, options?: Configuration): Promise<HttpInfo<void>>;
...
export declare class ObjectMergeApi {
    private api;
    ...
    mergeWithHttpInfo(param: MergeApiMergeRequest, options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;
    merge(param: MergeApiMergeRequest, options?: Configuration): Promise<SimplePublicObject>;
}

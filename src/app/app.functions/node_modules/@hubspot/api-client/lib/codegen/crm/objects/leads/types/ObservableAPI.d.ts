...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(leadsId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    archive(leadsId: string, _options?: Configuration): Observable<void>;
    ...
    getByIdWithHttpInfo(leadsId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>>;
    getById(leadsId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    ...
    updateWithHttpInfo(leadsId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;
    update(leadsId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject>;
}

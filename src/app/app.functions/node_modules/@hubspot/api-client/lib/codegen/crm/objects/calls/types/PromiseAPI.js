...
class PromiseBasicApi {
    ...
    archiveWithHttpInfo(callId, _options) {
        const result = this.api.archiveWithHttpInfo(callId, _options);
    ...
    getByIdWithHttpInfo(callId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getByIdWithHttpInfo(callId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    updateWithHttpInfo(callId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.updateWithHttpInfo(callId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }

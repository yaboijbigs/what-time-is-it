...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectType, objectId, toObjectType, toObjectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "toObjectType");
            }
            if (toObjectId === null || toObjectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "archive", "toObjectId");
            }
    ...
    create(objectType, objectId, toObjectType, toObjectId, associationSpec, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "objectId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "toObjectType");
            }
            if (toObjectId === null || toObjectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "toObjectId");
            }
            if (associationSpec === null || associationSpec === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "create", "associationSpec");
            }
            const localVarPath = '/crm/v4/objects/{objectType}/{objectId}/associations/{toObjectType}/{toObjectId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)))
    ...
    createDefault(fromObjectType, fromObjectId, toObjectType, toObjectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fromObjectType === null || fromObjectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "createDefault", "fromObjectType");
            }
            if (fromObjectId === null || fromObjectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "createDefault", "fromObjectId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "createDefault", "toObjectType");
            }
            if (toObjectId === null || toObjectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "createDefault", "toObjectId");
            }
    ...
    getPage(objectType, objectId, toObjectType, after, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getPage", "objectId");
            }
            if (toObjectType === null || toObjectType === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getPage", "toObjectType");
            }

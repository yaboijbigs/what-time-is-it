...
class PromiseBasicApi {
    ...
    archiveWithHttpInfo(lineItemId, _options) {
        const result = this.api.archiveWithHttpInfo(lineItemId, _options);
    ...
    getByIdWithHttpInfo(lineItemId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getByIdWithHttpInfo(lineItemId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    updateWithHttpInfo(lineItemId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.updateWithHttpInfo(lineItemId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }

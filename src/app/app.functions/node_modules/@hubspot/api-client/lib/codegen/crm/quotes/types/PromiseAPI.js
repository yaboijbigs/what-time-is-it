...
class PromiseBasicApi {
    ...
    archiveWithHttpInfo(quoteId, _options) {
        const result = this.api.archiveWithHttpInfo(quoteId, _options);
    ...
    getByIdWithHttpInfo(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getByIdWithHttpInfo(quoteId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    updateWithHttpInfo(quoteId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.updateWithHttpInfo(quoteId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }

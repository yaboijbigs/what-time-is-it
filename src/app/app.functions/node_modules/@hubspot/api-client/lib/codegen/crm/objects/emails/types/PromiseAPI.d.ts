...
export declare class PromiseBasicApi {
    ...
    archiveWithHttpInfo(emailId: string, _options?: Configuration): Promise<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(emailId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(emailId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;

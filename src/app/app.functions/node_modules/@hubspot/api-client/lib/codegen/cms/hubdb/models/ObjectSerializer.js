...
const BatchInputHubDbTableRowBatchCloneRequest_1 = require("../models/BatchInputHubDbTableRowBatchCloneRequest");
const BatchInputHubDbTableRowV3BatchUpdateRequest_1 = require("../models/BatchInputHubDbTableRowV3BatchUpdateRequest");
...
const BoundedNextPage_1 = require("../models/BoundedNextPage");
const BoundedPaging_1 = require("../models/BoundedPaging");
...
const HubDbTableRowBatchCloneRequest_1 = require("../models/HubDbTableRowBatchCloneRequest");
const HubDbTableRowV3_1 = require("../models/HubDbTableRowV3");
const HubDbTableRowV3BatchUpdateRequest_1 = require("../models/HubDbTableRowV3BatchUpdateRequest");
...
const RandomAccessCollectionResponseWithTotalHubDbTableRowV3_1 = require("../models/RandomAccessCollectionResponseWithTotalHubDbTableRowV3");
const SimpleUser_1 = require("../models/SimpleUser");
const StandardError_1 = require("../models/StandardError");
const StreamingCollectionResponseWithTotalHubDbTableRowV3_1 = require("../models/StreamingCollectionResponseWithTotalHubDbTableRowV3");
const UnifiedCollectionResponseWithTotalBaseHubDbTableRowV3_1 = require("../models/UnifiedCollectionResponseWithTotalBaseHubDbTableRowV3");
let primitives = [
    "string",
    "boolean",
    "double",
...
let typeMap = {
    "BatchInputHubDbTableRowBatchCloneRequest": BatchInputHubDbTableRowBatchCloneRequest_1.BatchInputHubDbTableRowBatchCloneRequest,
    "BatchInputHubDbTableRowV3BatchUpdateRequest": BatchInputHubDbTableRowV3BatchUpdateRequest_1.BatchInputHubDbTableRowV3BatchUpdateRequest,
    ...
    "BoundedNextPage": BoundedNextPage_1.BoundedNextPage,
    "BoundedPaging": BoundedPaging_1.BoundedPaging,
    ...
    "HubDbTableRowBatchCloneRequest": HubDbTableRowBatchCloneRequest_1.HubDbTableRowBatchCloneRequest,
    "HubDbTableRowV3": HubDbTableRowV3_1.HubDbTableRowV3,
    "HubDbTableRowV3BatchUpdateRequest": HubDbTableRowV3BatchUpdateRequest_1.HubDbTableRowV3BatchUpdateRequest,
    ...
    "RandomAccessCollectionResponseWithTotalHubDbTableRowV3": RandomAccessCollectionResponseWithTotalHubDbTableRowV3_1.RandomAccessCollectionResponseWithTotalHubDbTableRowV3,
    "SimpleUser": SimpleUser_1.SimpleUser,
    "StandardError": StandardError_1.StandardError,
    "StreamingCollectionResponseWithTotalHubDbTableRowV3": StreamingCollectionResponseWithTotalHubDbTableRowV3_1.StreamingCollectionResponseWithTotalHubDbTableRowV3,
    "UnifiedCollectionResponseWithTotalBaseHubDbTableRowV3": UnifiedCollectionResponseWithTotalBaseHubDbTableRowV3_1.UnifiedCollectionResponseWithTotalBaseHubDbTableRowV3,
};

...
exports.ListsApiResponseProcessor = exports.ListsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class ListsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    create(listCreateRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listCreateRequest === null || listCreateRequest === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "create", "listCreateRequest");
            }
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(listCreateRequest, "ListCreateRequest", ""), contentType);
    ...
    doSearch(listSearchRequest, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (listSearchRequest === null || listSearchRequest === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "doSearch", "listSearchRequest");
            }
    ...
    getAll(listIds, includeFilters, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (listIds !== undefined) {
                requestContext.setQueryParam("listIds", ObjectSerializer_1.ObjectSerializer.serialize(listIds, "Array<string>", ""));
            }
    ...
    getById(listId, includeFilters, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "getById", "listId");
            }
    ...
    getByName(listName, objectTypeId, includeFilters, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (listName === null || listName === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "getByName", "listName");
            }
            if (objectTypeId === null || objectTypeId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "getByName", "objectTypeId");
            }
    ...
    remove(listId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "remove", "listId");
            }
            const localVarPath = '/crm/v3/lists/{listId}'
                .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
    ...
    restore(listId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "restore", "listId");
            }
    ...
    updateListFilters(listId, listFilterUpdateRequest, enrollObjectsInWorkflows, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "updateListFilters", "listId");
            }
            if (listFilterUpdateRequest === null || listFilterUpdateRequest === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "updateListFilters", "listFilterUpdateRequest");
            }
    ...
    updateName(listId, listName, includeFilters, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (listId === null || listId === undefined) {
                throw new baseapi_1.RequiredError("ListsApi", "updateName", "listId");
            }
...
exports.ListsApiRequestFactory = ListsApiRequestFactory;
class ListsApiResponseProcessor {
    createWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListCreateResponse", "");
    ...
    getAllWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListsByIdResponse", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    getByIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListFetchResponse", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    updateListFiltersWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListUpdateResponse", "");
                return new http_1.HttpInfo(response.httpStatusCode, response.headers, response.body, body);
            }
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    updateNameWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ListUpdateResponse", "");
...
exports.ListsApiResponseProcessor = ListsApiResponseProcessor;

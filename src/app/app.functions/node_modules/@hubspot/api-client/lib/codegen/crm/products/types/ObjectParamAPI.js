...
class ObjectBasicApi {
    ...
    archiveWithHttpInfo(param, options) {
        return this.api.archiveWithHttpInfo(param.productId, options).toPromise();
    }
    ...
    getByIdWithHttpInfo(param, options) {
        return this.api.getByIdWithHttpInfo(param.productId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    ...
    updateWithHttpInfo(param, options) {
        return this.api.updateWithHttpInfo(param.productId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }

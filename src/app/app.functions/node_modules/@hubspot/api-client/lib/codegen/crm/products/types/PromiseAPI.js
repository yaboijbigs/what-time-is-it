...
class PromiseBasicApi {
    ...
    archiveWithHttpInfo(productId, _options) {
        const result = this.api.archiveWithHttpInfo(productId, _options);
    ...
    getByIdWithHttpInfo(productId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getByIdWithHttpInfo(productId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    updateWithHttpInfo(productId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.updateWithHttpInfo(productId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }

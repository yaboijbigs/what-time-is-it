...
exports.SitePagesApiResponseProcessor = exports.SitePagesApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class SitePagesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectId, archived, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "archive", "objectId");
            }
    ...
    archiveBatch(batchInputString, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputString === null || batchInputString === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "archiveBatch", "batchInputString");
            }
    ...
    attachToLangGroup(attachToLangPrimaryRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (attachToLangPrimaryRequestVNext === null || attachToLangPrimaryRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "attachToLangGroup", "attachToLangPrimaryRequestVNext");
            }
    ...
    clone(contentCloneRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contentCloneRequestVNext === null || contentCloneRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "clone", "contentCloneRequestVNext");
            }
    ...
    create(page, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (page === null || page === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "create", "page");
            }
    ...
    createABTestVariation(abTestCreateRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (abTestCreateRequestVNext === null || abTestCreateRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "createABTestVariation", "abTestCreateRequestVNext");
            }
    ...
    createBatch(batchInputPage, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputPage === null || batchInputPage === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "createBatch", "batchInputPage");
            }
    ...
    createLangVariation(contentLanguageCloneRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contentLanguageCloneRequestVNext === null || contentLanguageCloneRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "createLangVariation", "contentLanguageCloneRequestVNext");
            }
    ...
    detachFromLangGroup(detachFromLangGroupRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (detachFromLangGroupRequestVNext === null || detachFromLangGroupRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "detachFromLangGroup", "detachFromLangGroupRequestVNext");
            }
    ...
    endActiveABTest(abTestEndRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (abTestEndRequestVNext === null || abTestEndRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "endActiveABTest", "abTestEndRequestVNext");
            }
    ...
    getById(objectId, archived, property, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "getById", "objectId");
            }
            const localVarPath = '/cms/v3/pages/site-pages/{objectId}'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
    ...
    getDraftById(objectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "getDraftById", "objectId");
            }
    ...
    getPreviousVersion(objectId, revisionId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "getPreviousVersion", "objectId");
            }
            if (revisionId === null || revisionId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "getPreviousVersion", "revisionId");
            }
    ...
    getPreviousVersions(objectId, after, before, limit, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "getPreviousVersions", "objectId");
            }
    ...
    pushLive(objectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "pushLive", "objectId");
            }
    ...
    readBatch(batchInputString, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (batchInputString === null || batchInputString === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "readBatch", "batchInputString");
            }
    ...
    rerunPreviousABTest(abTestRerunRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (abTestRerunRequestVNext === null || abTestRerunRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "rerunPreviousABTest", "abTestRerunRequestVNext");
            }
    ...
    resetDraft(objectId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "resetDraft", "objectId");
            }
    ...
    restorePreviousVersion(objectId, revisionId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "restorePreviousVersion", "objectId");
            }
            if (revisionId === null || revisionId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "restorePreviousVersion", "revisionId");
            }
    ...
    restorePreviousVersionToDraft(objectId, revisionId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "restorePreviousVersionToDraft", "objectId");
            }
            if (revisionId === null || revisionId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "restorePreviousVersionToDraft", "revisionId");
            }
    ...
    schedule(contentScheduleRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contentScheduleRequestVNext === null || contentScheduleRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "schedule", "contentScheduleRequestVNext");
            }
    ...
    setLangPrimary(setNewLanguagePrimaryRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (setNewLanguagePrimaryRequestVNext === null || setNewLanguagePrimaryRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "setLangPrimary", "setNewLanguagePrimaryRequestVNext");
            }
    ...
    update(objectId, page, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "update", "objectId");
            }
            if (page === null || page === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "update", "page");
            }
            const localVarPath = '/cms/v3/pages/site-pages/{objectId}'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
    ...
    updateBatch(batchInputJsonNode, archived, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputJsonNode === null || batchInputJsonNode === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "updateBatch", "batchInputJsonNode");
            }
    ...
    updateDraft(objectId, page, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "updateDraft", "objectId");
            }
            if (page === null || page === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "updateDraft", "page");
            }
            const localVarPath = '/cms/v3/pages/site-pages/{objectId}/draft'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.PATCH);
    ...
    updateLangs(updateLanguagesRequestVNext, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (updateLanguagesRequestVNext === null || updateLanguagesRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("SitePagesApi", "updateLangs", "updateLanguagesRequestVNext");
            }
...
exports.SitePagesApiRequestFactory = SitePagesApiRequestFactory;
class SitePagesApiResponseProcessor {
...
exports.SitePagesApiResponseProcessor = SitePagesApiResponseProcessor;
//# sourceMappingURL=SitePagesApi.js.map
...
class ReportApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    request(userId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (userId === null || userId === undefined) {
                throw new baseapi_1.RequiredError("ReportApi", "request", "userId");
            }
...
class ReportApiResponseProcessor {
    requestWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "ReportCreationResponse", "");

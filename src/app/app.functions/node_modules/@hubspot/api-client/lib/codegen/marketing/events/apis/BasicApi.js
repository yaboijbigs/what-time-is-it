...
class BasicApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    batchArchive(batchInputMarketingEventExternalUniqueIdentifier, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputMarketingEventExternalUniqueIdentifier === null || batchInputMarketingEventExternalUniqueIdentifier === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "batchArchive", "batchInputMarketingEventExternalUniqueIdentifier");
            }
    ...
    batchUpsert(batchInputMarketingEventCreateRequestParams, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputMarketingEventCreateRequestParams === null || batchInputMarketingEventCreateRequestParams === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "batchUpsert", "batchInputMarketingEventCreateRequestParams");
            }
    ...
    cancel(externalEventId, externalAccountId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "cancel", "externalEventId");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "cancel", "externalAccountId");
            }
    ...
    complete(externalEventId, externalAccountId, marketingEventCompleteRequestParams, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "complete", "externalEventId");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "complete", "externalAccountId");
            }
            if (marketingEventCompleteRequestParams === null || marketingEventCompleteRequestParams === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "complete", "marketingEventCompleteRequestParams");
            }
    ...
    doSearch(q, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (q === null || q === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "doSearch", "q");
            }
    ...
    getDetails(externalEventId, externalAccountId, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getDetails", "externalEventId");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "getDetails", "externalAccountId");
            }
            const localVarPath = '/marketing/v3/marketing-events/events/{externalEventId}'
                .replace('{' + 'externalEventId' + '}', encodeURIComponent(String(externalEventId)));
            const requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.GET);
    ...
    upsert(externalEventId, marketingEventCreateRequestParams, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "upsert", "externalEventId");
            }
            if (marketingEventCreateRequestParams === null || marketingEventCreateRequestParams === undefined) {
                throw new baseapi_1.RequiredError("BasicApi", "upsert", "marketingEventCreateRequestParams");
            }
            const localVarPath = '/marketing/v3/marketing-events/events/{externalEventId}'
                .replace('{' + 'externalEventId' + '}', encodeURIComponent(String(externalEventId)));
...
class BasicApiResponseProcessor {
    ...
    batchArchiveWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    batchUpsertWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
    ...
    getDetailsWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {

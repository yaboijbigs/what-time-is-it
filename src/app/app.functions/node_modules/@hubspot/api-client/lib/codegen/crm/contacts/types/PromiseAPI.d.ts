...
export declare class PromiseBasicApi {
    ...
    archiveWithHttpInfo(contactId: string, _options?: Configuration): Promise<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(contactId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(contactId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;
...
export declare class PromiseGDPRApi {
    ...
    purgeWithHttpInfo(publicGdprDeleteInput: PublicGdprDeleteInput, _options?: Configuration): Promise<HttpInfo<void>>;
...
export declare class PromiseMergeApi {
    private api;
    ...
    mergeWithHttpInfo(publicMergeInput: PublicMergeInput, _options?: Configuration): Promise<HttpInfo<SimplePublicObject>>;

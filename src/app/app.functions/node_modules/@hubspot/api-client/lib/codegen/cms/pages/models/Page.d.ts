...
export declare enum PageLanguageEnum {
    Af = "af",
    AfNa = "af-na",
    AfZa = "af-za",
    Agq = "agq",
...
export declare enum PageContentTypeCategoryEnum {
    _0 = "0",
    _1 = "1",
    _2 = "2",
    _3 = "3",
...
export declare enum PageAbStatusEnum {
    Master = "master",
    Variant = "variant",
...
export declare enum PageCurrentStateEnum {
    Automated = "AUTOMATED",

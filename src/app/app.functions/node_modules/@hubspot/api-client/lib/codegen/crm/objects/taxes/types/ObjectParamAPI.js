...
class ObjectBasicApi {
    ...
    archiveWithHttpInfo(param, options) {
        return this.api.archiveWithHttpInfo(param.taxId, options).toPromise();
    }
    archive(param, options) {
        return this.api.archive(param.taxId, options).toPromise();
    }
    ...
    getByIdWithHttpInfo(param, options) {
        return this.api.getByIdWithHttpInfo(param.taxId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    getById(param, options) {
        return this.api.getById(param.taxId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    ...
    updateWithHttpInfo(param, options) {
        return this.api.updateWithHttpInfo(param.taxId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
    update(param, options) {
        return this.api.update(param.taxId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
}

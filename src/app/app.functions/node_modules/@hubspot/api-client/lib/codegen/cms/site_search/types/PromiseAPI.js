...
class PromisePublicApi {
    ...
    getByIdWithHttpInfo(contentId, type, _options) {
        const result = this.api.getByIdWithHttpInfo(contentId, type, _options);
    ...
    searchWithHttpInfo(q, limit, offset, language, matchPrefix, autocomplete, popularityBoost, boostLimit, boostRecent, tableId, hubdbQuery, domain, type, pathPrefix, property, length, groupId, _options) {
        const result = this.api.searchWithHttpInfo(q, limit, offset, language, matchPrefix, autocomplete, popularityBoost, boostLimit, boostRecent, tableId, hubdbQuery, domain, type, pathPrefix, property, length, groupId, _options);
        return result.toPromise();
    }

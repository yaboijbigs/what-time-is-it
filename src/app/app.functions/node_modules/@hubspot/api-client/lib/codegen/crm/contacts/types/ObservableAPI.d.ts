...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(contactId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(contactId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(contactId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;
...
export declare class ObservableGDPRApi {
    ...
    purgeWithHttpInfo(publicGdprDeleteInput: PublicGdprDeleteInput, _options?: Configuration): Observable<HttpInfo<void>>;
...
export declare class ObservableMergeApi {
    private requestFactory;
    private responseProcessor;
    private configuration;
    constructor(configuration: Configuration, requestFactory?: MergeApiRequestFactory, responseProcessor?: MergeApiResponseProcessor);
    mergeWithHttpInfo(publicMergeInput: PublicMergeInput, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;

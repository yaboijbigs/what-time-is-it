...
class SubscriberStateChangesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    upsertByContactEmail(externalEventId, subscriberState, externalAccountId, batchInputMarketingEventEmailSubscriber, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactEmail", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactEmail", "subscriberState");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactEmail", "externalAccountId");
            }
            if (batchInputMarketingEventEmailSubscriber === null || batchInputMarketingEventEmailSubscriber === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactEmail", "batchInputMarketingEventEmailSubscriber");
            }
    ...
    upsertByContactId(externalEventId, subscriberState, externalAccountId, batchInputMarketingEventSubscriber, _options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (externalEventId === null || externalEventId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactId", "externalEventId");
            }
            if (subscriberState === null || subscriberState === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactId", "subscriberState");
            }
            if (externalAccountId === null || externalAccountId === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactId", "externalAccountId");
            }
            if (batchInputMarketingEventSubscriber === null || batchInputMarketingEventSubscriber === undefined) {
                throw new baseapi_1.RequiredError("SubscriberStateChangesApi", "upsertByContactId", "batchInputMarketingEventSubscriber");
            }
...
class SubscriberStateChangesApiResponseProcessor {
    upsertByContactEmailWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    upsertByContactIdWithHttpInfo(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if ((0, util_1.isCodeInRange)("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");

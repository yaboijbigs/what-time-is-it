...
export declare class ObservableBasicApi {
    ...
    archiveWithHttpInfo(taxId: string, _options?: Configuration): Observable<HttpInfo<void>>;
    ...
    getByIdWithHttpInfo(taxId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObjectWithAssociations>>;
    ...
    updateWithHttpInfo(taxId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<HttpInfo<SimplePublicObject>>;

...
export declare enum BlogPostLanguageEnum {
    Af = "af",
    AfNa = "af-na",
    AfZa = "af-za",
    Agq = "agq",
...
export declare enum BlogPostContentTypeCategoryEnum {
    _0 = "0",
    _1 = "1",
    _2 = "2",
    _3 = "3",
...
export declare enum BlogPostAbStatusEnum {
    Master = "master",
    Variant = "variant",
...
export declare enum BlogPostCurrentStateEnum {
    Automated = "AUTOMATED",

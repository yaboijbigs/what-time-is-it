...
exports.ObjectSearchApi = exports.ObjectMergeApi = exports.ObjectGDPRApi = exports.ObjectBatchApi = exports.ObjectBasicApi = void 0;
...
class ObjectBasicApi {
    ...
    archiveWithHttpInfo(param, options) {
        return this.api.archiveWithHttpInfo(param.contactId, options).toPromise();
    }
    ...
    updateWithHttpInfo(param, options) {
        return this.api.updateWithHttpInfo(param.contactId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
...
class ObjectGDPRApi {
    ...
    purgeWithHttpInfo(param, options) {

...
class ObjectBasicApi {
    ...
    archiveWithHttpInfo(param, options) {
        return this.api.archiveWithHttpInfo(param.lineItemId, options).toPromise();
    }
    ...
    getByIdWithHttpInfo(param, options) {
        return this.api.getByIdWithHttpInfo(param.lineItemId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    ...
    updateWithHttpInfo(param, options) {
        return this.api.updateWithHttpInfo(param.lineItemId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }

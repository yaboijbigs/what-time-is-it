...
class ObjectBasicApi {
    ...
    archiveWithHttpInfo(param, options) {
        return this.api.archiveWithHttpInfo(param.emailId, options).toPromise();
    }
    ...
    getByIdWithHttpInfo(param, options) {
        return this.api.getByIdWithHttpInfo(param.emailId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    ...
    updateWithHttpInfo(param, options) {
        return this.api.updateWithHttpInfo(param.emailId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }

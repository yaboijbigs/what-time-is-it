...
exports.ObservableSearchApi = exports.ObservableMergeApi = exports.ObservableGDPRApi = exports.ObservableBatchApi = exports.ObservableBasicApi = void 0;
...
const MergeApi_1 = require("../apis/MergeApi");
class ObservableMergeApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new MergeApi_1.MergeApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new MergeApi_1.MergeApiResponseProcessor();
    }
...
exports.ObservableMergeApi = ObservableMergeApi;

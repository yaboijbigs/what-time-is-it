...
exports.ObservableDefinitionsApi = void 0;
...
class ObservableDefinitionsApi {
    ...
    archive(fromObjectType, toObjectType, associationTypeId, _options) {
        return this.archiveWithHttpInfo(fromObjectType, toObjectType, associationTypeId, _options).pipe((0, rxjsStub_2.map)((apiResponse) => apiResponse.data));
    }
